		...
		<div>
			<div class="nFlowBox">
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<tr>
						<td bgcolor="#ffffff" align="center"><a href="coursesDetail?id=${ce.id }"> <img
								style="width: 100px; height: 100px;"
								src="logos/${ce.cpicture }" border="0"
								title="${ce.cname }" />
						</a><br/><a style="text-decoration: none;" href="goodsDetail?id=${ce.id }" class="f6">${ce.cname }</a></td>
						<td bgcolor="#ffffff" width="110px" align="center"><span>${ce.crprice}</span></td>
